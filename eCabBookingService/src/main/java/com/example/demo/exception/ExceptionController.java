...
public class ExceptionController {
	 ...
	 public ResponseEntity<Object> exception(ResourceNotFoundException exception) {
		...
		@ExceptionHandler
		public ResponseEntity<String> exceptionHandler(CabNotFoundException cabNotFoundException) {
			return new ResponseEntity<String>(cabNotFoundException.getMessage(), HttpStatus.NOT_FOUND);
		}
}
